                    ...
                    <tr key={item.id} className="text-gray-800 bg-gray-400 border-b border-gray-600">
                        <td className="p-3 flex items-center">
                            ...
                            <div>
                                ...
                                <div className="italic">{item.email}</div>
                            </div>
                        </td>

                        <td className="p-3">
                            {item.active && <div className="px-2 py-1 inline-block border border-gray-800  bg-green-600 text-xs text-white">Active</div>}
                            {!item.active && <div className="px-2 py-1 inline-block border border-gray-800  bg-red-600 text-xs text-white">Inctive</div>}
                        </td>
